        ...
        <div class="container">
            ...
            <div class="error-page flex flex-col lg:flex-row items-center justify-center h-screen text-center lg:text-left">
                <div class="-intro-x lg:mr-20">
                    <img alt="Animation Error" class="h-48 lg:h-auto" src="{{ asset('assets/cms/images/error-illustration.svg') }}">
                </div>
                <div class="text-white mt-10 lg:mt-0">
                    ...
                    <a href="{{ url()->previous() }}" class="intro-x btn py-3 px-4 text-white border-white dark:border-darkmode-400 dark:text-slate-200 mt-10">Kembali ke Halaman Sebelumnya</a>
                </div>
            </div>
            <!-- END: Error Page -->
        </div>
