        ...
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap">
            ...
            <div class="w-full xl:w-auto flex items-center mt-1 lg:mt-0 ml-auto gap-2">
                @hasrole('admin|super_admin')
                    <a href="{{ route('order.full.index', ['export' => 'true']) }}" class="btn btn-sm btn-primary"><i class="w-4 h-4"
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            @hasrole('super_admin|admin|agent')
                <a href="{{ route('order.full.create') }}" class="btn btn-primary shadow-md mr-2">Tambah Pesanan</a>
            @endhasrole
                            ...
                            <tr class="intro-x">
                                ...
                                <td>
                                    <a class="text-slate-500 flex items-center mr-3"
                                        href="{{ route('order.full.show', $order) }}"> <i data-lucide="external-link"
