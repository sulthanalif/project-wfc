                    ...
                    <form action="{{ route('storePaymentAgent', $order) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mt-3 text-center">
                            ...
                            <span class="font-bold"> Rp.
                                {{ number_format($order->total_price - $order->payment()->where('status', 'accepted')->sum('pay'), 0, ',', '.') }}</span>
                        </div>
                        ...
                        <div class="mt-3">
                            ...
                            <input id="pay" name="pay" type="number"
                                value="{{ number_format($order->total_price - $order->payment()->where('status', 'accepted')->sum('pay'), 0, ',', '') }}"
