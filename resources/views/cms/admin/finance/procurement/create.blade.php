            ...
            <div class="intro-y box p-5">
                <form action="{{ route('spending.store') }}" method="post">
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        <div class="col-span-12 lg:col-span-6 intro-y">
                            ...
                            <div>
                                ...
                                <input id="date" name="date" type="date" class="form-control w-full"
                                    placeholder="Masukkan Jumlah Pengadaan" required>
                                @error('date')
                            ...
                            <div class="mt-3">
                                <label for="information" class="form-label">Item <span class="text-danger">*</span></label>
                                <select class="tom-select" id="item" name="spending_type_id" required>
                        ...
                        <div class="col-span-12 lg:col-spa  n-6 intro-y mt-3 lg:mt-0">
                            <div>
