                            ...
                            <tr class="intro-x">
                                ...
                                <td>
                                    <a class="text-slate-500 flex items-center mr-3"
                                        href="{{ route('catalog.show', $catalog) }}"> <i data-lucide="external-link"
                                    ...
                                    <div class="flex">
                                        <div class="w-10 h-10 image-fit zoom-in">
                                            <img alt="PAKET SMART WFC" class="tooltip rounded-full"
                                                src="{{ asset('storage/images/catalog/' . $catalog->image) }}"
                                                title="@if ($catalog->created_at == $catalog->updated_at)
                                                Diupload {{ \Carbon\Carbon::parse($catalog->created_at)->format('d M Y, H:m:i') }}
                                                @else
                                                Diupdate {{ \Carbon\Carbon::parse($catalog->updated_at)->format('d M Y, H:m:i') }}
                                                @endif">
                                        </div>
                                    </div>
                                </td>
