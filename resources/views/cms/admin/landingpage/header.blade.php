                    ...
                    <div class="grid grid-cols-12 gap-4">
                        <div class="col-span-12 lg:col-span-6 intro-y">
                            ...
                            <div class="mt-3">
                                ...
                                <div class="mt-2">
                                    <img src="{{ empty($header->image) ? asset('assets/logo2.png') : route('getImage', ['path' => 'landingpage', 'imageName' => $header->image]) }}" alt="" id="image-preview" class="w-auto h-40 object-cover rounded">
                                </div>
                                @error('image')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="col-span-12 lg:col-span-6 mt-3 lg:mt-0">
                            <div>
                                ...
                                <div>
                                    <textarea id="description" name="description" class="editor" required>{{ $header->description }}</textarea>
                                </div>
                                @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
