                    ...
                    <div class="grid grid-cols-12 gap-4">
                        <div class="col-span-12 lg:col-span-6 intro-y">
                            ...
                            <div class="mt-3">
                                ...
                                <div class="mt-2">
                                    <textarea id="bodyHistory" name="bodyHistory" class="form-control" placeholder="Masukkan isi Sejarah...">
                        ...
                        <div class="col-span-12 lg:col-span-6 intro-y mt-3 lg:mt-0">
                            ...
                            <div class="mt-3">
                                ...
                                <div class="mt-2">
                                    <textarea id="vision" name="vision" class="form-control" placeholder="Masukkan Visi...">
